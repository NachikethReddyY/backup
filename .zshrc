...
# NVM initialization (load before Oh My Zsh to avoid alias conflicts)
export NVM_DIR="$HOME/.nvm"
...
# Enable fzf-tab
zstyle ':fzf-tab:*' enable-popup true
...
# Case-insensitive completion search
...
export PATH="$PATH:/Users/reddyy/.local/bin"

# ─── Fabric ───────────────────────────────────────────────

# Alias — remove if installed via one-line installer (binary is already 'fabric')
# alias fabric='fabric-ai'   # Only needed for Homebrew installs
...
export PATH="$PATH:/Users/reddyy/.lmstudio/bin"
